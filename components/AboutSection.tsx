        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-7 lg:gap-16">
          ...
          >
            ...
            <motion.p
              ...
              className="text-lg sm:text-xl md:text-2xl font-semibold bg-sky-100 text-sky-500 mb-4 sm:mb-6 px-4 py-2 rounded-lg inline-block shadow-md"
            >
            ...
            >
              <span className="text-sm sm:text-base px-3 py-1 rounded-full bg-sky-100 text-sky-500 shadow-md">
                {t("aboutUs.founded")}
              </span>
              <span className="text-sm sm:text-base px-3 py-1 rounded-full bg-sky-100 text-sky-500 shadow-md">
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl leading-relaxed bg-sky-100 text-sky-500 py-2 px-4 rounded-lg text-gray-200 lg:mx-0 mb-5"
            >
            ...
            >
              <a
                ...
                className="inline-flex items-center bg-gradient-to-r from-sky-600 to-sky-700 text-white font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-xl shadow-md hover:shadow-lg hover:from-sky-700 hover:to-sky-200 transition-all duration-300 transform hover:scale-15"
                aria-label="Call Hadiya Travel"
              >
                <FiPhoneCall className="w-5 h-5 sm:w-6 sm:h-6 mr-2" />
                <span>+998 88 038-38-38</span>
              </a>
              <p className="inline-flex items-center bg-gradient-to-r from-sky-600 to-sky-700 text-white font-semibold py-2 px-4 sm:py-3 sm:px-6 rounded-xl shadow-md hover:shadow-lg hover:from-sky-700 hover:to-sky-200 transition-all duration-300 transform hover:scale-15">
          ...
          >
            ...
            >
              <button
                ...
                className="relative border-2 border-sky-500 bg-sky-400 overflow-hidden text-white font-semibold py-2 px-6 sm:py-3 sm:px-8 rounded-xl shadow-lg transition-all duration-300 transform hover:scale-105 hover:shadow-xl group"
              >
                <span className="absolute inset-0 bg-sky-600 transform scale-x-0 group-hover:scale-x-100 origin-left transition-transform duration-300 ease-in-out"></span>
            ...
            >
              {[
                ...
                <motion.a
                  ...
                  className="p-3 sm:p-4 bg-gradient-to-r from-sky-600 to-sky-700 text-white font-semibold rounded-full shadow-md hover:shadow-lg hover:from-sky-700 hover:to-sky-200 transition-all duration-300 transform hover:scale-15"
